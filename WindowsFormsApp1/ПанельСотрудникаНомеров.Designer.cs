...
{
    partial class ПанельСотрудникаНомеров
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ПанельСотрудникаНомеров));
            ...
            this.orderuserlistTableAdapter = new WindowsFormsApp1.ОтельDataSetTableAdapters.orderuserlistTableAdapter();
            this.пользователиBindingSource = new System.Windows.Forms.BindingSource(this.components);
            this.пользователиTableAdapter = new WindowsFormsApp1.ОтельDataSet1TableAdapters.ПользователиTableAdapter();
            ...
            this.orderuserlistBindingSource.DataSource = this.отельDataSet;
            // 
            ...
            this.пользователиBindingSource.DataSource = this.отельDataSet1;
            // 
            ...
            this.label1.Text = "Панель сотрудника обслуживания номеров";
            // 
            // pictureBox1
            // 
            ...
            this.Name = "ПанельСотрудникаНомеров";
            this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
            this.Text = "Отель - Панель сотрудника обслуживающего номера";
            this.Load += new System.EventHandler(this.ПанельСотрудникаНомеров_Load);
            this.MouseDown += new System.Windows.Forms.MouseEventHandler(this.ПанельСотрудникаНомеров_MouseDown);
            this.MouseMove += new System.Windows.Forms.MouseEventHandler(this.ПанельСотрудникаНомеров_MouseMove);
            this.MouseUp += new System.Windows.Forms.MouseEventHandler(this.ПанельСотрудникаНомеров_MouseUp);
        ...
        private ОтельDataSetTableAdapters.orderuserlistTableAdapter orderuserlistTableAdapter;
        private System.Windows.Forms.Button button2;
        private System.Windows.Forms.Button button1;
        private ОтельDataSet1 отельDataSet1;
        private System.Windows.Forms.BindingSource пользователиBindingSource;
        private ОтельDataSet1TableAdapters.ПользователиTableAdapter пользователиTableAdapter;
